...
@javax.servlet.annotation.WebServlet(name = "RegisteredServlet")
public class RegisteredServlet extends javax.servlet.http.HttpServlet {
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            Date user_borthday = borthdayDate.parse(request.getParameter("user_borthday"));
        ...
        int user_match_status = Integer.parseInt(request.getParameter("user_match_status"));
        ...
        //判断
        if (userPhone==null){ //用户是否已经到表中
              userDao.insertUser(userPhone);
