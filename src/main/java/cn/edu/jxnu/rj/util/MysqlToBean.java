...
import java.util.List;
    ...
    public class MysqlToBean {
        ...
        public List<String> TBlist() throws Exception {
            ...
            DatabaseMetaData md = con.getMetaData(); //数据库元数据，调用其方法可以获得数据库的信息

            List<String> list = null;
            String[] types = {"Table"};
            ResultSet rs = md.getTables(null, null, "db_campus_%", types);
            //调用getTables方法可以获取指定表，
            if (rs != null) {
        ...
        public void GenEntity(List<String> TBlist, String packageName)throws Exception {
            ...
            for (int k = 0; k < TBlist.size(); k++) {
                ...
                rsmd = pstmt.getMetaData();//得到结果集的结构信息
                ...
                markerBean(initcap(tablename.substring(10)), parse(), packageName);
            }
            pstmt = null;
            rsmd = null;
            conn = null;
        ...
        private String parse() {
            ...
            sb.append("public class " + initcap(tablename.substring(10)) + " {\r\n");
            processAllAttrs(sb);
            processAllMethod(sb);
            sb.append("}\r\n");
...
//            System.setProperty("https.protocols", "TLSv1.2");
            MysqlToBean auto = new MysqlToBean();
            List<String> list = auto.TBlist();
            System.out.println(list);
            auto.GenEntity(list, "main/java/cn/edu/jxnu/rj/domain");
        }
}
